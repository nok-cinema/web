...
Insert into MOVIE (MOVIEID,MOVIENAME,CATEGORY,DIRECTOR,SHORTDESCRIPTION,ACTOR,DURATION,PLAYCOUNT,STATUS,SHOWDATE) values (2,'20 Mai','Romantic','??????','20 ??? ??','??????',120,null,null,to_date('04-DEC-16','DD-MON-RR'));
